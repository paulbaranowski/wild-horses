...
- Write the full refactor plan to `docs/plans/active/YYYY-MM-DD-harness-review-<short-description>.md` (where YYYY-MM-DD is today's date) including scope, findings, proposed changes, affected files, and trade-offs
