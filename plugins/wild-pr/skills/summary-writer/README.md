...
8. **Detects changed external surfaces** (CLI, API, config, UI) and captures one before/after example each - screenshots/recordings for visual surfaces, saved outside the worktree and handed off as placeholders since a PR body can't accept drag-and-drop uploads via API.
