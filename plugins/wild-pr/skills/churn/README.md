...
The full instructions Claude follows when this skill runs are in [`SKILL.md`](./SKILL.md), which passes through to [`../../commands/churn.md`](../../commands/churn.md). The six lens prompts live in [`references/lenses.md`](./references/lenses.md). This README is a pointer for people browsing the repo.
...
5. **Recommends** one verdict: keep patching, refactor in this PR, split the PR, restart with new requirements, or move the change to another component. It names the runner-up and why it lost.
