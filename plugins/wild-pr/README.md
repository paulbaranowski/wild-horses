...
| **[`churn`](skills/churn/)**                   | `/wild-pr:churn`          | Diagnoses why a PR keeps going through review rounds: clusters the findings by root cause and runs six parallel lens agents. Then it recommends one verdict, such as a refactor or moving the change to the component that should own it. |
