...
- Write the full remediation plan to `docs/plans/active/YYYY-MM-DD-reasoning-gaps-<short-description>.md` (where YYYY-MM-DD is today's date) including scope, all findings, all 5 interventions with details
...
- Write the full remediation plan to `docs/plans/active/YYYY-MM-DD-reasoning-gaps-<short-description>.md` (where YYYY-MM-DD is today's date) including scope, all findings, all 5 interventions with details and effort estimates
