...
> 1. **Save plan and implement** -- Write the plan to `docs/plans/` and start implementing it
> 2. **Save plan** -- Write the plan to `docs/plans/` for later
> 3. **Revise** -- Provide feedback to refine the proposal

### Option 1: Save plan and implement

- Write the full refactor plan to `docs/plans/harness-review-<short-description>.md` including scope, findings, proposed changes, affected files, and trade-offs
